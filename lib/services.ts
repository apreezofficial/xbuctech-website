...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: "X-BUC TECH helps businesses maintain secure, reliable, and efficient IT environments through ongoing technical support and systems management. We help manage the technology your business depends on, resolve technical issues, and keep systems properly configured, maintained, and available.",
  ...
  },
  {
    ...
    description: "X-BUC TECH helps organizations manage and optimize the infrastructure that supports their business operations. From cloud administration and infrastructure management to backup, disaster recovery, and cloud security, we provide solutions designed to improve reliability, scalability, security, and business continuity.",
  ...
  },
  {
    ...
    description: "X-BUC TECH provides software testing and quality assurance services designed to help businesses identify defects, validate functionality, and improve application reliability before software reaches end users. We use a combination of manual and automated testing to evaluate applications across key workflows, functionality, and changes.",
